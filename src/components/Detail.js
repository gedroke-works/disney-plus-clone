...
function Detail() {
  ...
  return (
    <Container>
        <Background>
            <img src="/images/detail-mha4k.png" alt=""/>
        </Background>
        <Wrap>
            <ImageTitle>
                <img src="/images/detail-mha-logo.png" alt=""/>
            </ImageTitle>
            <Controls>
                <PlayButton>
            ...
            <Subtitle>
                2017 - 2 seasons - Anime, Action, Shonen
            </Subtitle>
            <Description>
                After saving a bully from the hands of a villain,
                a normal teenager starts taking superhero lessons
